  ...
  useEffect(() => {
    const fetchRecordings = async () => {
      ...
      try {
        ...
        console.log("Lỗi khi tải bản ghi:", error);
      }
    };
  ...
  return (
    <div className="container max-w-7xl mx-auto p-6">
      ...
      <p className="text-muted-foreground my-1">
        {recordings.length} {recordings.length === 1 ? "bản ghi" : "bản ghi"} có sẵn
      </p>
      ...
      <ScrollArea className="h-[calc(100vh-12rem)] mt-3">
        {recordings.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-[400px] gap-4">
            <p className="text-xl font-medium text-muted-foreground">Không có sẵn bản ghi</p>
          </div>
        )}
      </ScrollArea>
    </div>
